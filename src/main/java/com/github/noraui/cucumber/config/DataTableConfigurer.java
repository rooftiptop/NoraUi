...
public class DataTableConfigurer implements TypeRegistryConfigurer {
    ...
    public void configureTypeRegistry(TypeRegistry registry) {
        ...
        registry.defineDataTableType(new DataTableType(GherkinConditionedLoopedStep.class,
        ...
        registry.defineParameterType(new ParameterType<PageElement>("page-element", "\\'(.+\\..+-.+)\\'",
